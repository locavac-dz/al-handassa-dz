...
| `ssl-config.test.js` | `sslConfig()` (`config/database.js`) : les 4 modes `DB_SSL`, lecture de `DB_SSL_CA` (contenu PEM ou chemin de fichier), refus explicite si ni l'un ni l'autre |
